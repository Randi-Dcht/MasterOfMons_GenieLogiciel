...
public class PlayingState extends GameState implements Observer {
    ...
    public void init() {
        ...
        /*supprimer =>*/SuperviserNormally.getSupervisor().newParty("NamePlayer",Type.beefy, gs, People.Gender.Men,Difficulty.Easy); SuperviserNormally.getSupervisor().setQuest(questShower);
