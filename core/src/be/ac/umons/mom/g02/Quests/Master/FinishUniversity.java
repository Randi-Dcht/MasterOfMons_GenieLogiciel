...
public class FinishUniversity extends MasterQuest {
    ...
    final UnderQuest[] underQuest = {/*TODO rajouter le combat contre le boss (ca rapporte 15) sans oublier de mettre le boss dans les mobiles */}; //il manquait le joueur
    ...
    public FinishUniversity(People people, MasterQuest before, GraphicalSettings grahic, Difficulty difficulty) {
        super(before, people, Bloc.MA2, difficulty);
